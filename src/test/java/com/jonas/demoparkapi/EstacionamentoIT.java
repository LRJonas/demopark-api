...
import com.jonas.demoparkapi.JwtAuthentication;
...
@Sql(scripts = "/sql/estacionamento/estacionamentos-insert.sql", executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
@Sql(scripts = "/sql/estacionamento/estacionamentos-delete.sql", executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD)
public class EstacionamentoIT {
    ...
    @Sql(scripts = "/sql/estacionamento/estacionamento-insert-vagas-ocupadas.sql", executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
    @Sql(scripts = "/sql/estacionamento/estacionamento-delete-vagas-ocupadas.sql", executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD)
    @Test
    ...
    public void buscarEstacionamentos_PorClienteCpf_RetornarSucesso() {
        ...
        PagebleDto responseBody = testClient.get()
