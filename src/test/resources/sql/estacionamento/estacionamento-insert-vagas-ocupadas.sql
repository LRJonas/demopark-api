...
insert into clientes (id, nome, cpf, usuario_id) values (21, 'Biatriz Rodrigues', '09191773016', 101);
insert into clientes (id, nome, cpf, usuario_id) values (22, 'Rodrigo Silva', '98401203015', 102);
